...
this._buildCell(e,b,d,c,this.options.columns[d]);e.append(f)}}},_buildRow:function(a,b,c){c=$("<tr></tr>").appendTo(c);var e=this._guid();c.attr("data-uid",e);this.options.rowFunction!=null&&this.options.rowFunction(c,a,b);return c},_buildCell:function(a,b,c,e,d){var f=$("<td></td>");f.addClass("col"+c);f.addClass("column");f.attr("data-field",d.field);if(d.width!=null)try{f.css("width",d.width)}catch(g){console.log(g)}this._applyStyle(f,d.style);if(d.customAttributes!=null)try{f.attr(d.customAttributes)}catch(h){console.log(h)}c=
...
this.tableBody.animate({opacity:1},200)},_applyStyle:function(a,b){a==null||b==null||(typeof b=="string"?a.addClass(b):a.css(b))},_guid:function(){var a=function(){return((1+Math.random())*65536|0).toString(16).substring(1)};return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()},destroy:function(){$.Widget.prototype.destroy.apply(this,arguments)}});
