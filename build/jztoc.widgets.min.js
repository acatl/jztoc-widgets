...
arguments)}});
$.ui.uicomponent.subclass("ui.grid",{options:{dataProvider:null,columns:[],rowFunction:null},_create:function(){this.element.addClass("ui-grid");this.redraw()},redraw:function(a){if(typeof a!="undefined"){if(typeof a.columns!="undefined")this.options.columns=a.columns;if(typeof a.rowFunction!="undefined")this.options.rowFunction=a.rowFunction;if(typeof a.dataProvider!="undefined")this.options.dataProvider=a.dataProvider}if(this.options.id==null||this.options.id=="")this.options.id=this._guid();this._removeTable();
this.elements.table=$("<table></table>").attr("id",this.options.id).addClass("grid").appendTo(this.element);this.elements.tableHead=$("<thead></thead>").appendTo(this.elements.table);this.elements.tableBody=$("<tbody></tbody>").appendTo(this.elements.table);this._createTableHeader(this.options.columns);this.options.dataProvider!=null&&this._updateData()},_createTableHeader:function(a){tr=$("<tr></tr>");for(var b in a)this._createHeaderCell(tr,b,a[b]).appendTo(tr);tr.appendTo(this.elements.tableHead)},
_createHeaderCell:function(a,b,c){var e=$("<th></th>");e.addClass("col"+b);e.addClass("header");e.attr("data-field",c.field);if(c.customHeaderAttributes!=null)try{e.attr(c.customHeaderAttributes)}catch(d){}var f=null;if(c.headerRenderer!=null)f=c.headerRenderer;else if(this.options.headerRenderer!=null)f=this.options.headerRenderer;if(f!=null){a={listData:{owner:this,data:null,column:c,index:b,th:e,tr:a}};c.itemRendererOptions!=null&&jQuery.extend(a,c.headerOptions);e[f](a)}else e.html(c.label);c.headerAttr!=
null&&e.attr(c.headerAttr);c.headerStyle!=null&&this._applyStyle(e,c.headerStyle);if(c.width!=null)try{e.css("width",c.width)}catch(g){}c.visible==false&&e.hide();return e},_updateData:function(){$(this.elements.tableBody).children().remove();var a=this.options.dataProvider,b;for(b in a){var c=a[b],e=this._buildRow(b,c,this.elements.tableBody),d;for(d in this.options.columns){var f=this._buildCell(e,b,d,c,this.options.columns[d]);e.append(f)}}},_buildRow:function(a,b,c){c=$("<tr></tr>").appendTo(c);
var e=this._guid();c.attr("data-uid",e);this.options.rowFunction!=null&&this.options.rowFunction(c,a,b);return c},_buildCell:function(a,b,c,e,d){var f=$("<td></td>");f.addClass("col"+c);f.addClass("column");f.attr("data-field",d.field);this._applyStyle(f,d.style);if(d.customAttributes!=null)try{f.attr(d.customAttributes)}catch(g){}c=this._assignlabelData(e,d);d.visible==false&&f.hide();if(d.itemRenderer!=null||d.rendererFunction!=null){a={data:c,listData:{owner:this,data:e,column:d,index:b,td:f,tr:a}};
d.itemRendererOptions!=null&&jQuery.extend(a,d.itemRendererOptions);if(d.itemRenderer!=null)f[d.itemRenderer](a);else d.rendererFunction!=null&&d.rendererFunction(f,a)}else f.html(c);typeof c=="string"&&d.showToolTip==true&&f.attr("title",c);d.styleFunction!=null&&d.styleFunction(f,b,e,d);return f},_assignlabelData:function(a,b){if(b.labelFunction!=null)return b.labelFunction(a,b);if(b.labelField!=null)return a[b.field][b.labelField];if(a[b.field]!=null)return a[b.field];return""},_setOption:function(a,
b){switch(a){case "dataProvider":this.options.dataProvider=b;this._updateData();break;case "columns":this.options.columns=b;this._updateData()}$.Widget.prototype._setOption.apply(this,arguments)},showLoading:function(){this.elements.table.addClass("loading");this.elements.tableBody.animate({opacity:0.1},200)},hideLoading:function(){this.elements.table.removeClass("loading");this.elements.tableBody.animate({opacity:1},200)},_applyStyle:function(a,b){a==null||b==null||(typeof b=="string"?a.addClass(b):
a.css(b))},_guid:function(){var a=function(){return((1+Math.random())*65536|0).toString(16).substring(1)};return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()},_removeTable:function(){if(typeof this.elements.table!="undefined"){this.elements.table.remove();delete this.elements.table;delete this.elements.tableBody;delete this.elements.tableHead}},destroy:function(){$.Widget.prototype.destroy.apply(this,arguments);this._removeTable()}});
