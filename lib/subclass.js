        ...
        case 'options':
          ...
          break;
				case 'elements':
					...
					proto.elements = $.extend({}, superproto.elements, elements);
					break;
				case '_properties':
					var _properties = proto._properties;
					proto._properties = $.extend({}, superproto._properties, _properties);
					break;
				case 'states':
					var states = proto.states;
					proto.states = $.extend({}, superproto.states, states);
					break;
				case '_helpers':
					var _helpers = proto._helpers;
					if ( typeof superproto._helpers == "undefined") superproto._helpers = [];
					proto._helpers = superproto._helpers.concat(_helpers);
					break;
